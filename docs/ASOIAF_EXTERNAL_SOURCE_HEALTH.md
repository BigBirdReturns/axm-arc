...
```bash
npx vite-node tools/asoiaf-external-source-health.ts -- init --root .asoiaf-external-estate
npx vite-node tools/asoiaf-external-source-health.ts -- audit --root .asoiaf-external-estate --at 2026-08-04T00:00:00Z
npx vite-node tools/asoiaf-external-source-health.ts -- plan --root .asoiaf-external-estate --limit 40
npx vite-node tools/asoiaf-external-source-health.ts -- report --root .asoiaf-external-estate
npx vite-node tools/asoiaf-external-source-health.ts -- observe-route --root .asoiaf-external-estate --source grrm-not-a-blog --target https://georgerrmartin.com/notablog/ --status available --http-status 200
npx vite-node tools/asoiaf-external-source-health.ts -- verify --root .asoiaf-external-estate
npx vite-node tools/asoiaf-external-source-health.ts -- receipt --root .asoiaf-external-estate --out source-health-receipt.json
```
