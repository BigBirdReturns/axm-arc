...
} from "../src/burn-protocol/episode-4-chapter-2.js";
...
const output = resolve(
  process.argv[2] ?? "burn-protocol-through-episode-04-chapter-02-publication",
);
...
console.log(json({
  ...
  chapterBoundary: "E04-C1-P20 -> E04-C2-P21",
  continuationPanelId: "E04-C3-P41",
}).trimEnd());
