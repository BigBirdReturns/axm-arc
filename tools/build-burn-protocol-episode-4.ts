...
} from "../src/burn-protocol/episode-4-chapter-3.js";
...
const output = resolve(
  process.argv[2] ?? "burn-protocol-through-episode-04-publication",
);
...
const receiptPath = await writeJson(`${prefix}.publication-receipt.json`, {
  ...
  canonicalSeams: [
    { fromPanelId: "E03-C3-P60", toPanelId: "E04-C1-P01" },
    { fromPanelId: "E04-C1-P20", toPanelId: "E04-C2-P21" },
    { fromPanelId: "E04-C2-P40", toPanelId: "E04-C3-P41" },
  ],
  sourceCustody: {
...
console.log(json({
  ...
  chapterBoundary: "E04-C2-P40 -> E04-C3-P41",
  continuationPanelId: "E05-C1-P01",
}).trimEnd());
