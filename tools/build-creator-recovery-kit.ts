...
for (const [source, destination] of [
  ...
  ["creator-kit/GENERIC_ARC_CONTRACT.md", "contracts/GENERIC_ARC_CONTRACT.md"],
  ...
  ["src/engine/schema.ts", "contracts/reference-source/schema.ts"],
  ["src/engine/types.ts", "contracts/reference-source/types.ts"],
  ["src/engine/bounded-json.ts", "contracts/reference-source/bounded-json.ts"],
  ["src/engine/cartridge-digest.ts", "contracts/reference-source/cartridge-digest.ts"],
  ["src/engine/determinism.ts", "contracts/reference-source/determinism.ts"],
